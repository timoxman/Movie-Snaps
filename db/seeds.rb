...
User.create! :name => 'Andy Gout', :email => 'tim@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars0.githubusercontent.com/u/11789455?v=3&s=400'
...
User.create! :name => 'Tim Oxman', :email => 'andy@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars0.githubusercontent.com/u/10484515?v=3&s=400'

Movie.create([
                {name:"The Da Vinci Code (2006)",imdbID:"tt0382625"},
                {name:"Grease (1976)",imdbID:"tt0077631"},
                {name:"Inception (2010)",imdbID:"tt1375666"},
                {name:"Lost In Translation (2003)",imdbID:"tt0335266"},
                {name:"Amelie (2001)",imdbID:"tt0211915"},
                {name:"Attack on Titan (2015)",imdbID:"tt2072230"},
                ...
                {name:"Avengers Assemble (2012)",imdbID:"tt0848228"},
                ...
                {name:"The Royal Tennenbaums (2001)",imdbID:"tt0265666"},
                ...
                {name:"Die Another Day (2002)",imdbID:"tt0246460"}
    ])
...
Location.create([
                ...
                {user_id:3,name:"", description:"Die Another Day", latitude:51.500964,longitude:-0.119639,address:"Westminster Bridge Road, London, SE1"}
    ]) 
Scene.create([
...
Photo.create([
                ...
                {caption:"The name's Bond...",image_file_name:"http://i284.photobucket.com/albums/ll37/ashleigh_louise1/Movie%20Snaps/Fan%20photos/Die%20Another%20Day%20-%20Big%20Ben%20-%20Fan%20Photo_zpsgf47gzzw.jpg",visit_id:51}
    ])
