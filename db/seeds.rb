...
User.create! :name => 'Jennifer Arad-Marks', :email => 'jen@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars3.githubusercontent.com/u/11654909?v=3&s=400'
User.create! :name => 'Daryl Watson', :email => 'daryl@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars2.githubusercontent.com/u/9296416?v=3&s=400'
User.create! :name => 'Tim Oxman', :email => 'tim@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars0.githubusercontent.com/u/11789455?v=3&s=400'
User.create! :name => 'Ashleigh Maund', :email => 'ashleigh@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars2.githubusercontent.com/u/8567247?v=3&s=400'
User.create! :name => 'Stefan Lissia', :email => 'stefan@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars1.githubusercontent.com/u/6443068?v=3&s=400'
User.create! :name => 'Andy Gout', :email => 'andy@gmail.com', :password => 'topsecret', :password_confirmation => 'topsecret', :image => 'https://avatars0.githubusercontent.com/u/10484515?v=3&s=400'

# TO BE SEEDED AGAIN... AS FINAL SEED
Movie.create([
        {name:"The Da Vinci Code (2006)",imdbID:"tt0382625"},
        {name:"Grease (1978)",imdbID:"tt0077631"},
        {name:"Inception (2010)",imdbID:"tt1375666"},
        {name:"Lost In Translation (2003)",imdbID:"tt0335266"},
        {name:"Amelie (2001)",imdbID:"tt0211915"},
        {name:"Attack on Titan (2013)",imdbID:"tt2072230"},
        {name:"On Her Majesty's Secret Service (1969)",imdbID:"tt0064757"},
        {name:"Breakfast at Tiffany's (1961)",imdbID:"tt0054698"},
        {name:"The Graduate (1967)",imdbID:"tt0061722"},
        {name:"The Sound of Music (1965)",imdbID:"tt0059742"},
        {name:"Ghostbusters (1984)",imdbID:"tt0087332"},
        {name:"Sex and the City (2008)",imdbID:"tt1000774"},
        {name:"Indiana Jones and the Last Crusade (1989)",imdbID:"tt0097576"},
        {name:"The Dark Knight (2008)",imdbID:"tt0468569"},
        {name:"The Dark Knight Rises (2012)",imdbID:"tt1345836"},
        {name:"The Godfather (1972)",imdbID:"tt0068646"},
        {name:"Scarface (1983)",imdbID:"tt0086250"},
        {name:"Manhattan (1979)",imdbID:"tt0079522"},
        {name:"Notting Hill (1999)",imdbID:"tt0125439"},
        {name:"Lock Stock and Two Smoking Barrels (1998)",imdbID:"tt0120735"},
        {name:"Madagascar (2005)",imdbID:"tt0351283"},
        {name:"Snatch (2000)",imdbID:"tt0208092"},
        {name:"The Avengers (2012)",imdbID:"tt0848228"},
        {name:"Zoolander (2001)",imdbID:"tt0196229"},
        {name:"Live and Let Die (1973)",imdbID:"tt0070328"},
        {name:"The Wolf of Wall Street (2013)",imdbID:"tt0993846"},
        {name:"When Harry Met Sally (1989)",imdbID:"tt0098635"},
        {name:"Superman (1979)",imdbID:"tt0078346"},
        {name:"The Royal Tenenbaums (2001)",imdbID:"tt0265666"},
        {name:"Raging Bull (1980)",imdbID:"tt0081398"},
        {name:"Night at the Museum (2006)",imdbID:"tt2692250"},
        {name:"Men In Black (1997)",imdbID:"tt0127385"},
        {name:"Rocky (1976)",imdbID:"tt0075148"},
        {name:"Home Alone (1990)",imdbID:"tt0099785"},
        {name:"The Italian Job (1969)",imdbID:"tt0317740"},
        {name:"Goodfellas (1990)",imdbID:"tt0099685"},
        {name:"The Notebook (2004)",imdbID:"tt0332280"},
        {name:"Goldeneye (1995)",imdbID:"tt0113189"},
        {name:"The Fox and the Hound (1981)",imdbID:"tt0082406"},
        {name:"Die Hard (1988)",imdbID:"tt0095016"},
        {name:"Skyfall (2012)",imdbID:"tt107463"},
        {name:"Mission Impossible (1996)",imdbID:"tt0117060"}
  ])
...
Visit.create([
        ...
        {scene_id:2,user_id:2,description: 'This was filmed here'},
        {scene_id:3,user_id:3,description: 'This was filmed here'},
        {scene_id:4,user_id:4,description: 'This was filmed here'},
        {scene_id:5,user_id:5,description: 'This was filmed here'},
        {scene_id:6,user_id:6,description: 'This was filmed here'},
        {scene_id:7,user_id:1,description: 'This was filmed here'},
        {scene_id:8,user_id:2,description: 'This was filmed here'},
        {scene_id:9,user_id:3,description: 'This was filmed here'},
